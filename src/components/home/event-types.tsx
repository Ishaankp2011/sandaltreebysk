...
export function EventTypes() {
  return (
    <section className="section-padding bg-secondary/20" aria-labelledby="events-heading">
            ...
            >
              ...
              >
                ...
                <div className="absolute bottom-0 left-0 right-0 p-3 md:p-6">
                  <h3 className="font-serif text-base md:text-2xl text-white font-light mb-1 md:mb-2">
                    {event.title}
                  </h3>
                  {/* Description: visible on md+, hidden on mobile to save space */}
                  <p className="hidden md:block font-sans text-sm text-white/70 leading-relaxed mb-3 opacity-0 group-hover:opacity-100 transition-opacity duration-500">
                    {event.description}
                  </p>
                  <span className="inline-flex items-center gap-1.5 font-sans text-[10px] md:text-xs text-primary tracking-widest uppercase md:opacity-0 md:group-hover:opacity-100 transition-opacity duration-500">
                    Learn More
